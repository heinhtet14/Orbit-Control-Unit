...
/* USER CODE BEGIN PV */
uint8_t rxBuffer[49];
uint8_t txBuffer[9] = {"A$$17\r"};
uint16_t dev_add[4] = {0x30,0x31,0x62,0x63};
uint8_t pressure_buffer[7];
uint8_t mass_flow_buffer[7];
uint8_t temp_buffer[4];
float mass_flow,pressure;
/* USER CODE END PV */
...
int main(void)
{
  /* USER CODE BEGIN 1 */
	...
	//HAL_UART_Receive_DMA(&huart3, rxBuffer, 50);
  /* USER CODE END 1 */
